...
def run(seed_param,trials_FOC, trials_SOC, num_KC, KC_baseline, odor_activation, odor_FOC, odor_SOC, init_KCMBONp,
            init_KCMBONn, initMBONpDAN, LR_KCMBONn, LR_MBONpDAN, overlap, ref_odor, DAN_activation=False):
    '''
    ...
    pref_odor3 = preference_test.test_model_overlap_test(num_KC=num_KC, KC_baseline=KC_baseline,odor_activation=odor_activation, test_odor='odor3',wKC_MBONp=wKC_MBONp, wKC_MBONn=wKC_MBONn, overlap=overlap,ref_odor=ref_odor,seed_param=seed_param)
    test_results.update({"post FOC odor3": pref_odor3})



    for i, trial in enumerate(np.arange(trials_SOC + 1, trials + 1)):
        KC, DAN, MBONp, MBONn, wKC_MBONp, wKC_MBONn, wMBONp_DAN = single_trial.single_trial_model5(num_KC=num_KC, KC_baseline=KC_baseline, odor_activation=odor_activation, odor=odor_SOC, init_KCMBONp=init_KCMBONp, init_KCMBONn=init_KCMBONn, init_MBONpDAN=initMBONpDAN, KC=KC,wKC_MBONp=wKC_MBONp, wKC_MBONn=wKC_MBONn, wMBONp_DAN=wMBONp_DAN, DAN=DAN, LR_KCMBONn=LR_KCMBONn, LR_MBONpDAN=LR_MBONpDAN, DAN_activation=0,seed_param=seed_param,ref_odor=ref_odor,overlap=overlap,overlap_on=True)
    ...
    pref_odor1 = preference_test.test_model_overlap_test(num_KC=num_KC, KC_baseline=KC_baseline,
                                                    odor_activation=odor_activation, test_odor='odor1',
                                                    wKC_MBONp=wKC_MBONp, wKC_MBONn=wKC_MBONn, overlap=overlap,ref_odor=ref_odor,
                                                    seed_param=seed_param)
    test_results.update({"post SOC odor1": pref_odor1})

    pref_odor2 = preference_test.test_model_overlap_test(num_KC=num_KC, KC_baseline=KC_baseline,
...
#DAN_rate, MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights, MBONp_DAN_weights, test_results = run(seed_param=np.random.randint(1,999,1),trials_FOC=3, trials_SOC=3, num_KC=2000, KC_baseline=0, odor_activation=3, odor_FOC='odor1', odor_SOC='odor1_2', init_KCMBONp=0.083,
 #                 init_KCMBONn=0.083, initMBONpDAN=0.080808 , LR_KCMBONn=0.003182, LR_MBONpDAN=0.003000,overlap = 25,ref_odor='odor1', DAN_activation=4.727273)
...
for i in [0,25,50,75,100]:
    ...
    DAN_rate, MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights, MBONp_DAN_weights, test_results = run(seed_param=np.random.randint(1,999,1),trials_FOC=3, trials_SOC=3, num_KC=2000, KC_baseline=0, odor_activation=3, odor_FOC='odor1', odor_SOC='odor1_2', init_KCMBONp=0.083,
                  init_KCMBONn=0.083, initMBONpDAN=0.080808 , LR_KCMBONn=0.003182, LR_MBONpDAN=0.003000,overlap = i,ref_odor='odor1', DAN_activation=4.727273)
