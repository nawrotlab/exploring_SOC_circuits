...
def run_model2(seed_param,trials_FOC,trials_SOC,trials_3OC,trials_4OC,trials_5OC,num_KC,KC_baseline, odor_activation, odor_FOC, odor_SOC,odor_3OC,odor_4OC,odor_5OC, init_KCMBONp,
            init_KCMBONn, initKCDAN, LR_KCMBONn, LR_KCDAN, DAN_activation=False):
    ...
    for i, trial in enumerate(np.arange(trials_SOC + 1, trials_FOC + trials_SOC + 1)):
        KC, DAN, MBONp, MBONn, wKC_MBONp, wKC_MBONn, wKC_DAN = single_trial.single_trial_model2(num_KC=num_KC,
                                                                                                        KC_baseline=KC_baseline,
                                                                                                        odor_activation=odor_activation,
                                                                                                        odor=odor_SOC,
                                                                                                        init_KCMBONp=init_KCMBONp,
                                                                                                        init_KCMBONn=init_KCMBONn,
                                                                                                        init_KCDAN=initKCDAN,
                                                                                                        KC=KC,
                                                                                                        wKC_MBONp=wKC_MBONp,
                                                                                                        wKC_MBONn=wKC_MBONn,
                                                                                                        wKC_DAN=wKC_DAN,
...
if __name__ == '__main__':
    ...
    DAN_rate,MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights, KC_DAN_weights, test_results = run_model2(seed_param=np.random.randint(1,999,1),trials_FOC=3, trials_SOC=3, trials_3OC=3, trials_4OC=3,trials_5OC=3,
    ...
    print(test_results['post SOC odor2'])
    print(test_results['post 3OC odor4'])
    print(test_results['post 4OC odor5'])
    print(test_results['post 5OC odor6'])
