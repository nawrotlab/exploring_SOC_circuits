...
def run(seed_param,trials_FOC, trials_SOC, num_KC, KC_baseline, odor_activation, odor_FOC, odor_SOC, init_KCMBONp,
            init_KCMBONn, initKCDAN, LR_KCMBONn, LR_KCDAN, overlap, DAN_activation=False):
    '''
...
for i in [0,25,50,75,100]:
    ...
    DAN_rate, MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights, KC_DAN_weights, test_results = run(
        ...
        init_KCMBONn=0.083, initKCDAN=0.000505, LR_KCMBONn=0.003333, LR_KCDAN=0.000677, overlap=i,
        DAN_activation=5.727273)

    results2.update({str(i):test_results})
