...
def run(seed_param,trials_FOC, trials_SOC, num_KC, KC_baseline, odor_activation, odor_FOC, odor_SOC, init_KCMBONp,
            init_KCMBONn, initMBONpDAN,initMBONnDAN, LR_KCMBONn, DAN_activation=False,variable_connectivity=False,variable_weight=False,generalization_exp=False):
    '''
       ...
       :return: DAN_rate, MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights, MBONp_DAN_weights, MBONn_DAN_weights, test_results
    ...
    KC, wKC_MBONp, wKC_MBONn, wMBONp_DAN, wMBONn_DAN, MBONp, MBONn, DAN = models.create_model3(num_KC=num_KC, init_KCMBONp=init_KCMBONp, init_KCMBONn=init_KCMBONn, init_MBONpDAN=initMBONpDAN, init_MBONnDAN=initMBONnDAN)

    if variable_connectivity == True:
        KC, wKC_MBONp, wKC_MBONn, wMBONp_DAN, wMBONn_DAN, MBONp, MBONn, DAN = models_var_connectivity.create_model3(num_KC=num_KC,
                                                                                                   init_KCMBONp=init_KCMBONp,
                                                                                                   init_KCMBONn=init_KCMBONn,
                                                                                                   init_MBONpDAN=initMBONpDAN,
                                                                                                   init_MBONnDAN=initMBONnDAN)
    if variable_weight == True:
        KC, wKC_MBONp, wKC_MBONn, wMBONp_DAN, wMBONn_DAN, MBONp, MBONn, DAN = models_var_connectivity.create_model3(
            num_KC=num_KC,
            init_KCMBONp=init_KCMBONp,
            init_KCMBONn=init_KCMBONn,
            init_MBONpDAN=initMBONpDAN,
    ...
    for i, trial in enumerate(np.arange(1, trials_FOC + 1)):
        KC, DAN, MBONp, MBONn, wKC_MBONp, wKC_MBONn, wMBONp_DAN, wMBONn_DAN = single_trial.single_trial_model3(num_KC=num_KC, KC_baseline=KC_baseline, odor_activation=odor_activation, odor=odor_FOC, init_KCMBONp=init_KCMBONp, init_KCMBONn=init_KCMBONn, init_MBONpDAN=initMBONpDAN, init_MBONnDAN=initMBONnDAN, KC=KC,wKC_MBONp=wKC_MBONp, wKC_MBONn=wKC_MBONn, wMBONp_DAN=wMBONp_DAN, wMBONn_DAN=wMBONn_DAN, DAN=DAN, LR_KCMBONn=LR_KCMBONn,DAN_activation=DAN_activation,ref_odor=None,seed_param=seed_param)
    ...
    for i, trial in enumerate(np.arange(trials_SOC + 1, trials + 1)):
        KC, DAN, MBONp, MBONn, wKC_MBONp, wKC_MBONn, wMBONp_DAN, wMBONp_DAN = single_trial.single_trial_model3(num_KC=num_KC, KC_baseline=KC_baseline, odor_activation=odor_activation, odor=odor_SOC, init_KCMBONp=init_KCMBONp, init_KCMBONn=init_KCMBONn, init_MBONpDAN=initMBONpDAN, init_MBONnDAN=initMBONnDAN, KC=KC,wKC_MBONp=wKC_MBONp, wKC_MBONn=wKC_MBONn, wMBONp_DAN=wMBONp_DAN, wMBONn_DAN=wMBONn_DAN, DAN=DAN, LR_KCMBONn=LR_KCMBONn, DAN_activation=0,ref_odor=None,seed_param=seed_param)
    ...
    if generalization_exp==True:
        for i, trial in enumerate(np.arange(3)):
            KC, DAN, MBONp, MBONn, wKC_MBONp, wKC_MBONn, wMBONp_DAN, wMBONp_DAN = single_trial.single_trial_model3(
                num_KC=num_KC, KC_baseline=KC_baseline, odor_activation=odor_activation, odor='odor3',
                init_KCMBONp=init_KCMBONp, init_KCMBONn=init_KCMBONn, init_MBONpDAN=initMBONpDAN,
                init_MBONnDAN=initMBONnDAN, KC=KC, wKC_MBONp=wKC_MBONp, wKC_MBONn=wKC_MBONn, wMBONp_DAN=wMBONp_DAN,
                wMBONn_DAN=wMBONn_DAN, DAN=DAN, LR_KCMBONn=LR_KCMBONn, DAN_activation=0, ref_odor=None,
...
if __name__ == '__main__':
    ...
    DAN_rate, MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights, MBONp_DAN_weights, MBONn_DAN_weights, test_results = run(seed_param=np.random.randint(1,999,1),trials_FOC=3, trials_SOC=3, num_KC=2000, KC_baseline=0, odor_activation=3, odor_FOC='odor1', odor_SOC='odor1_2', init_KCMBONp=0.083,
             init_KCMBONn=0.083, initMBONpDAN=0.272727, initMBONnDAN=0.262626, LR_KCMBONn=0.003121, DAN_activation=5,generalization_exp=True)
