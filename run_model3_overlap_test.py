...
def run(seed_param,trials_FOC, trials_SOC, num_KC, KC_baseline, odor_activation, odor_FOC, odor_SOC, init_KCMBONp,
            init_KCMBONn, initMBONpDAN,initMBONnDAN, LR_KCMBONn, overlap,ref_odor,DAN_activation=False):
    '''
...
for i in [0,25,50,75,100]:
    DAN_rate, MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights, MBONp_DAN_weights, MBONn_DAN_weights, test_results = run(
        ...
        init_KCMBONn=0.083, initMBONpDAN=0.272727, initMBONnDAN=0.262626, LR_KCMBONn=0.003121, overlap=i,ref_odor='odor2',
        DAN_activation=5)
    results3.update({str(i):test_results})
