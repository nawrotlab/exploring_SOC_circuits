...
# # run experiments with all models with variable KC-MBON weights
...
np.save('/Users/anna/Documents/Arbeit/Promotion/FOR2705/SecondOrderConditioning/MS_Anna_Felix_Martin/publication_data/figure4/fig4b/results1', results1)
...
for i in (np.arange(sample_size)):
    DAN_rate, MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights, KC_DAN_weights, test_results = run_model2.run(seed_param=np.random.randint(1,999,1),trials_FOC=3, trials_SOC=3, num_KC=2000, KC_baseline=0, odor_activation=3, odor_FOC='odor1', odor_SOC='odor1_2', init_KCMBONp=0.083,
                 init_KCMBONn=0.083, initKCDAN=0.000505 , LR_KCMBONn=0.003333, LR_KCDAN=0.000677,DAN_activation=5.727273,variable_weight=True)
...
np.save('/Users/anna/Documents/Arbeit/Promotion/FOR2705/SecondOrderConditioning/MS_Anna_Felix_Martin/publication_data/figure4/fig4b/results2', results2)
...
for i in (np.arange(sample_size)):
    DAN_rate, MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights, MBONp_DAN_weights, MBONn_DAN_weights, test_results = run_model3.run(seed_param=np.random.randint(1,999,1),trials_FOC=3, trials_SOC=3, num_KC=2000, KC_baseline=0, odor_activation=3, odor_FOC='odor1', odor_SOC='odor1_2', init_KCMBONp=0.083,
                 init_KCMBONn=0.083, initMBONpDAN=0.272727, initMBONnDAN=0.262626, LR_KCMBONn=0.003121, DAN_activation=5,variable_weight=True)
...
np.save('/Users/anna/Documents/Arbeit/Promotion/FOR2705/SecondOrderConditioning/MS_Anna_Felix_Martin/publication_data/figure4/fig4b/results3', results3)
...
for i in (np.arange(sample_size)):
    DAN_rate, MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights,  MBONn_DAN_weights, test_results = run_model4.run(seed_param=np.random.randint(1,999,1),trials_FOC=3, trials_SOC=3, num_KC=2000, KC_baseline=0, odor_activation=3, odor_FOC='odor1', odor_SOC='odor1_2', init_KCMBONp=0.083,
                 init_KCMBONn=0.083, initMBONnDAN=0.131313, LR_KCMBONn=0.003182, DANbaseline=11.212121, DAN_activation=3.727273,variable_weight=True)
...
np.save('/Users/anna/Documents/Arbeit/Promotion/FOR2705/SecondOrderConditioning/MS_Anna_Felix_Martin/publication_data/figure4/fig4b/results4', results4)
...
for i in (np.arange(sample_size)):
    DAN_rate, MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights, KC_KC_weights, KC_DAN_weights, test_results = run_model5.run(seed_param=np.random.randint(1,999,1),trials_FOC=3, trials_SOC=3, num_KC=2000, KC_baseline=0, odor_activation=3, odor_FOC='odor1', odor_SOC='odor1_2', init_KCMBONp=0.083,
             init_KCMBONn=0.083, init_KCKC=0, init_KCDAN=0.001000, LR_KCMBONn=0.004000,LR_KCKC=0.000162, DAN_activation=7.272727,variable_weight=True)
...
np.save('/Users/anna/Documents/Arbeit/Promotion/FOR2705/SecondOrderConditioning/MS_Anna_Felix_Martin/publication_data/figure4/fig4b/results5', results5)
