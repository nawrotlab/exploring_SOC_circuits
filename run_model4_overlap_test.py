...
def run(seed_param,trials_FOC, trials_SOC, num_KC, KC_baseline, odor_activation, odor_FOC, odor_SOC, init_KCMBONp,
            init_KCMBONn, initMBONnDAN, LR_KCMBONn, DANbaseline, overlap,ref_odor,DAN_activation=False):
    '''
...
for i in [0,25,50,75,100]:
    DAN_rate, MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights, MBONn_DAN_weights, test_results = run(
        ...
        init_KCMBONn=0.083, initMBONnDAN=0.131313, LR_KCMBONn=0.003182, DANbaseline=11.212121, overlap=i,ref_odor='odor1',
        DAN_activation=3.727273)




    results4.update({str(i):test_results})
