...
def run(seed_param,trials_FOC, trials_SOC, num_KC, KC_baseline, odor_activation, odor_FOC, odor_SOC, init_KCMBONp,
            init_KCMBONn, init_KCKC, init_KCDAN, LR_KCMBONn,LR_KCKC, overlap,DAN_activation=False):
    '''
...
for i in [0,25,50,75,100]:
    ...
    DAN_rate, MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights, KC_KC_weights, KC_DAN_weights, test_results = run(
        ...
        init_KCMBONn=0.083, init_KCKC=0, init_KCDAN=0.001000, LR_KCMBONn=0.004000, LR_KCKC=0.000162, overlap=i,
