...
def run(seed_param,trials_FOC, trials_SOC, num_KC, KC_baseline, odor_activation, odor_FOC, odor_SOC, init_KCMBONp,
            init_KCMBONn, init_KCKC, init_KCDAN, LR_KCMBONn,LR_KCKC, DAN_activation=False):
    '''
    ...
    KC, wKC_MBONp, wKC_MBONn, wKC_DAN, wKC_KC, MBONp, MBONn, DAN = models.create_model6(num_KC=num_KC, init_KCMBONp=init_KCMBONp, init_KCMBONn=init_KCMBONn, init_KCKC=init_KCKC,init_KCDAN=init_KCDAN)
    ...
    for i, trial in enumerate(np.arange(1, trials_FOC + 1)):
        KC, DAN, MBONp, MBONn, wKC_MBONp, wKC_MBONn, wKC_DAN, wKC_KC  = single_trial.single_trial_model6(num_KC=num_KC, KC_baseline=KC_baseline, odor_activation=odor_activation, odor=odor_FOC, init_KCMBONp=init_KCMBONp, init_KCMBONn=init_KCMBONn,init_KCDAN=init_KCDAN,init_KCKC=init_KCKC, KC=KC,wKC_MBONp=wKC_MBONp, wKC_MBONn=wKC_MBONn,wKC_DAN=wKC_DAN, wKC_KC=wKC_KC, DAN=DAN, LR_KCMBONn=LR_KCMBONn,LR_KCKC=LR_KCKC, DAN_activation=DAN_activation,seed_param=seed_param)
    ...
    for i, trial in enumerate(np.arange(trials_SOC + 1, trials + 1)):
        KC, DAN, MBONp, MBONn, wKC_MBONp, wKC_MBONn, wKC_DAN, wKC_KC = single_trial.single_trial_model6(num_KC=num_KC, KC_baseline=KC_baseline, odor_activation=odor_activation, odor=odor_SOC, init_KCMBONp=init_KCMBONp, init_KCMBONn=init_KCMBONn, init_KCKC=init_KCKC,init_KCDAN=init_KCDAN, KC=KC,wKC_MBONp=wKC_MBONp, wKC_MBONn=wKC_MBONn, wKC_DAN=wKC_DAN, wKC_KC=wKC_KC,DAN=DAN, LR_KCMBONn=LR_KCMBONn, LR_KCKC=LR_KCKC,DAN_activation=0,seed_param=seed_param)
...
DAN_rate, MBONp_rate, MBONn_rate, KC_MBONp_weights, KC_MBONn_weights, KC_KC_weights, KC_DAN_weights, test_results = run(seed_param=np.random.randint(1,999,1),trials_FOC=3, trials_SOC=3, num_KC=2000, KC_baseline=0, odor_activation=3, odor_FOC='odor1', odor_SOC='odor1_2', init_KCMBONp=0.083,
        init_KCMBONn=0.083, init_KCKC=0, init_KCDAN=0.03, LR_KCMBONn=0.004,LR_KCKC=0.001, DAN_activation=10)
